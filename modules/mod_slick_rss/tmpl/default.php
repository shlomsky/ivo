...
?>
<ul class="slick-rss-list<?php echo $params->get('moduleclass_sfx'); ?>" style="padding-left:0px;margin:0 0 0 30px;">
<?php
if($slick_rss['items']){
foreach($slick_rss['items'] as $item){
        ...
        print '
        <li style="list-style-type:square;" class="slick-rss-item'.$params->get('moduleclass_sfx').'">
